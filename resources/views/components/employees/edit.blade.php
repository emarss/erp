        ...
        <div class="card-body">
            <form method="post">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-lg-6">
                        ...
                        <div class="input-group input-group--inline">
                            ...
                            <input wire:model="position" type="text" class="form-control" name="position"
                ...
                <div class="form-row">
                    <div class="form-group col-lg-6">
                        ...
                        <div class="input-group input-group--inline">
                            ...
                            <input wire:model="engagement_date" type="date" class="form-control" name="engagement_date"
                                placeholder="Engagement Date">
                        </div>
                        @error('engagement_date') <span class="invalid-feedback">{{ $message }}</span> @enderror
                    </div>
                    <div class="form-group col-lg-6">
                        ...
                        <div class="input-group input-group--inline">
                            ...
                            <input wire:model="termination_date" type="date" class="form-control" name="termination_date"
                ...
                <div class="form-group">
                    ...
                    <div class="input-group input-group--inline">
                        <textarea  wire:model="employment_history" class="form-control" name="employment_history"
                        placeholder="Employement History"></textarea>
                    </div>
                    @error('employment_history') <span class="invalid-feedback">{{ $message }}</span> @enderror
                </div>
                <hr class="opacity-0 my-1">
            ...
            <button class="btn btn-primary btn-sm" wire:click="updateEmployee">Save</button>
        </div>
    </div>
</div>
