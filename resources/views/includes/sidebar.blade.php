<nav class="drawer drawer--dark">
    ...
    <ul class="drawer-menu">
        ...
        <li class="drawer-menu-item drawer-submenu">
            <a data-toggle="collapse" data-parent="#pagesMenu" href="#" data-target="#salesMenu"
                aria-controls="salesMenu" aria-expanded="false" class="collapsed">
...
{{--
        <li class="drawer-menu-item drawer-submenu">
            <a data-toggle="collapse" data-parent="#pagesMenu" href="#" data-target="#financesMenu"
                aria-controls="financesMenu" aria-expanded="false" class="collapsed">
        ...
        <li class="drawer-menu-item drawer-submenu">
            <a data-toggle="collapse" data-parent="#pagesMenu" href="#" data-target="#adminMenu"
                aria-controls="adminMenu" aria-expanded="false" class="collapsed">
        ...
        <li class="drawer-menu-item drawer-submenu">
            <a data-toggle="collapse" data-parent="#pagesMenu" href="#" data-target="#systemMenu"
                aria-controls="systemMenu" aria-expanded="false" class="collapsed">
